<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wewbform.aspx.cs" Inherits="WebApplication3.wewbform" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Label ID="Label1" runat="server" Text="Send OTP Application"></asp:Label>
